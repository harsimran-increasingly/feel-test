...
//         var cssFilePath = "https://www.increasingly.co/Clients/flUN19e/css/flUN19e.css";
...
})("5b440efe-603a-494d-8c89-4c55a4d489f6");
...
INC.addConversionPixelFile = function () {
    // var conversionPixelFilePath = "https://www.increasingly.co/Implementation/tP41Kns/js/increasingly_tP41Kns_conversion.js";
    // var scriptTag = document.createElement('script');
    // scriptTag.type = "text/javascript";
    // scriptTag.src = conversionPixelFilePath;
...
INC.dataStore.methods = function () {
    ...
    function buildDataStoreObj(bundleResponse) {
        if(INC.config.pageType == "pdp"){
            var date_current=getCurrentFormattedTime()
            var userDetails_ = detect_device_type()
            INC.config.bundleCount = bundleResponse.BundleCount
            Indicative.buildEvent('BundleRequest', {Date: date_current.split(' ')[0].toString(),ProductId:INC.config.Product_id.toString(),Category:bundleResponse.Bundles[0].Products[0].CategoryId.toString(),Brand:'feelunique',NumberofBundles:bundleResponse.BundleCount.toString(),BundlesShown:'Yes',ExperimentGroup:'',VisitorID:INC.config.ivid,Device:userDetails_[0].navigatoredevice,Referrer:document.referrer,Domain:'https://www.feelunique.com/',ReferrerProtocol:document.referrer.split('://')[0],City:'',Country:'',State:'',Language:'EN',DeviceType:userDetails_[0].navigatoredevice,Browser:userDetails_[0].browsernname,PageType:'Product Details Page',PageID:'100',OS:userDetails_[0].osname.toString(),OSVersion:userDetails_[0].osversion.toString(),BrowserName:userDetails_[0].browsernname.toString(),BrowserVersion:'',NavigatorUserAgent:userDetails_[0].navigatoruserAgent.toString(),NavigatorAppVersion:userDetails_[0].navigatorappVersion.toString(),NavigatorPlatform:userDetails_[0].navigatorplatform.toString(),NavigatorVendor :userDetails_[0].navigatorvendor.toString()},callbackFn);
...
INC.classes.ProductObj = function (product) {
    ...
    this.imageURL = ((product != null) && (product != undefined)) ? product["ImageURL"].replace('_listing','') : "";
...
INC.classes.ProductAttObj = function (product) {
    ...
    this.imageURL = ((product != null) && (product != undefined)) ? product["childProductImageUrl"].replace('_listing','') : "";
            ...
            if(xhr.response != ""){
                ...
                if(INC.config.pageType == "pdp"){
                    ...
                    for(i=0; i < dataLayer.length; i++){
                        ...
                        if(dataLayer[i]["ecommerce"] != undefined && dataLayer[i]["ecommerce"]["detail"] != undefined){       
                            if(dataLayer[i]["ecommerce"]["detail"]["products"] != undefined){
                                categoryId = dataLayer[i]["ecommerce"]["detail"]["products"][0].category;
                            }                    
                        }
                    } 
                    Indicative.buildEvent('BundleRequest', {Date: date_current.split(' ')[0].toString(),ProductId:INC.config.Product_id.toString(),Category:categoryId.toString(),Brand:'feelunique',NumberofBundles:'',BundlesShown:'No',ExperimentGroup:'',VisitorID:INC.config.ivid.toString(),Device:userDetails_[0].navigatoredevice.toString(),Referrer:document.referrer.toString(),Domain:'https://www.feelunique.com/',ReferrerProtocol:document.referrer.split('://')[0].toString(),City:'',Country:'',State:'',Language:'EN',DeviceType:userDetails_[0].navigatoredevice,Browser:userDetails_[0].browsernname.toString(),PageType:'Product Details Page',PageID:'100',OS:userDetails_[0].osname.toString(),OSVersion:userDetails_[0].osversion.toString(),BrowserName:userDetails_[0].browsernname.toString(),BrowserVersion:'',NavigatorUserAgent:userDetails_[0].navigatoruserAgent.toString(),NavigatorAppVersion:userDetails_[0].navigatorappVersion.toString(),NavigatorPlatform:userDetails_[0].navigatorplatform.toString(),NavigatorVendor :userDetails_[0].navigatorvendor.toString()},callbackFn);
                }
                INC_mutation=true
                if(INC.config.pageType == "pdp"){
                    var p_ids=INC.methods.getProductIdFromWebPage()
...
INC.methods.irbReq = function (productId, bundleCount, elementName) {
    ...
    // }
    if(INC.config.pageType == "pdp" || INC.config.pageType == "cartPage" || INC.config.pageType == "productList" || INC.config.pageType == "ticket"){
        var irbReqParams =
                ...
                switch (INC.config.pageType) {
                    ...
                    case "productList":
                        setTimeout(function(){
                            ...
                            if(document.querySelector('.simplemodal-container .ddTitleText') == null){
                                INC.config.dupDataObjectProducts=[]
                                ...
                                jQuery('#subbuyform #buysub').on("click", function(ev){
                                    if(this.parentNode.querySelector('#sp_opt1_title') != null){
                                        if(this.parentNode.querySelector('#sp_opt1_title').innerText.indexOf('Please select') == -1){
                                            ...
                                            if(INC.clientConfig.plpwrapper != null){
                                                ...
                                                update_plp_sidebar(INC.clientConfig.plpwrapper,errhtml)
                                                INC.clientConfig.plpwrapper = null
                                            }
                                        }
                                    }
...
INC.methods.showSidebar = function () {
    if(document.querySelector('.inc_sidebar_modal_block') != null){
        ...
        if(INC.config.pageType == "pdp"){
            ...
            bundle_id =  document.querySelector('.inc_pdp_product-main_block .inc_product_module_block').getAttribute('data-bundle_id')
            }
            var date_current=getCurrentFormattedTime()
            var userDetails_ = detect_device_type()
            var categoryId = ""
            ...
            Indicative.buildEvent('MainProductSidebarOpen', {Date: date_current.split(' ')[0].toString(),ProductId:INC.dataStore.pdpProductId.toString(),BundleID: bundle_id.toString(),PrimaryProduct: INC.dataStore.pdpProductId.toString(), SecondaryProduct:"", Category:categoryId.toString(),Brand:'feelunique',NumberofBundles:'',BundlesShown:'No',ExperimentGroup:'',VisitorID:INC.config.ivid.toString(),Device:userDetails_[0].navigatoredevice.toString(),Referrer:document.referrer.toString(),Domain:'https://www.feelunique.com/',ReferrerProtocol:document.referrer.split('://')[0].toString(),PageType:'Product Details Page',PageID:pageType.toString(),OS:userDetails_[0].osname.toString(),OSVersion:userDetails_[0].osversion.toString(),BrowserName:userDetails_[0].browsernname.toString(),BrowserVersion:'',NavigatorUserAgent:userDetails_[0].navigatoruserAgent.toString(),NavigatorAppVersion:userDetails_[0].navigatorappVersion.toString(),NavigatorPlatform:userDetails_[0].navigatorplatform.toString(),NavigatorVendor :userDetails_[0].navigatorvendor.toString()},callbackFn);
        }
...
INC.methods.hideSidebar = function () {
    if (document.querySelector('#simplemodal-container .simplemodal-close') != null){
        document.querySelector('#simplemodal-container .simplemodal-close').click();
    }
...
INC.methods.createAMBlock = function (ticket) {
    if(INC.dataStore.dataStoreObj.undefined == undefined){
        ...
        if (productBlocks.length > prd_length) {
            ...
            amBlock.querySelector(getSelectorClassName(classNames, "afLeftBtnBlock")).setAttribute("style", "pointer-events: none;opacity:0");
            ...
            amBlock.querySelector(getSelectorClassName(classNames, "afLeftBtnImg")).setAttribute("style", "pointer-events: none;opacity:0");
        }
        amBlock.querySelector(getSelectorClassName(classNames, "afRightBtnBlock")).addEventListener("click", function () {
            ...
            if(+INC.clientConfig.slidevalue + +cc_ount == all_p_length){
                amBlock.parentNode.parentNode.querySelector(getSelectorClassName(classNames, "afRightBtnBlock")).setAttribute("style", "pointer-events: none;opacity:0");
                amBlock.parentNode.parentNode.querySelector(getSelectorClassName(classNames, "afRightBtnImg")).setAttribute("style", "pointer-events: none;opacity:0");
            }
        });
        ...
        amBlock.querySelector(getSelectorClassName(classNames, "afLeftBtnBlock")).addEventListener("click", function () {
            ...
            if(INC.clientConfig.slidevalue == 0){
                amBlock.parentNode.parentNode.querySelector(getSelectorClassName(classNames, "afLeftBtnBlock")).setAttribute("style", "pointer-events: none;opacity:0");
                amBlock.parentNode.parentNode.querySelector(getSelectorClassName(classNames, "afLeftBtnImg")).setAttribute("style", "pointer-events: none;opacity:0");
            }
        });
...
INC.methods.createPDPBlock = function (sidebar) {
    ...
    if(sidebar != "sidebar"){
        if(INC.dataStore.dataStoreObj.undefined != undefined || empty_sidebarflag == false){
            ...
            INC.methods.clear();
            // if (readCookie('ivid') == "b96ae89ddcdfdccefe66a499af9de1abd0c93fa6ce"){
            //     debugger;
            // }
...
INC.methods.addSidebarToClientCartButton = function () {
...
INC.methods.createProductShowcaseBlock = function (pdpProductId, blockType, bundleProductListCheck,parentblock) {
    ...
    if(deschtml.querySelector('.m_product-description') != null){
        var desctext = deschtml.querySelector('.m_product-description').innerText.trim().split('\n')[0]
    }
    if(desctext == ""){
    ...
    // elproductPriceLabel.innerText = "PRICE";
...
INC.methods.createProductModalBlock = function (pdpProductId, blockType, bundleProductListCheck,parentblock) {
    ...
    if(productObj.description != ""){
        ...
        // if(desctext == ""){
        //     if(productObj.description.split('\n')[2] != undefined){
        //         if(productObj.description.split('\n')[2].length > 100) {
        //             if(window.innerWidth > 767){
        //                 desctext = productObj.description.split('\n')[2]//.substring(0,100);
        //             }else{
        //                 desctext = productObj.description.split('\n')[2]//.substring(0,120);
        //             }
        //         }
        //     }else{
        //         if(productObj.description.length > 100) {
        //             if(window.innerWidth > 767){
        //                 desctext = productObj.description//.substring(0,100);
        //             }else{
        //                 desctext = productObj.description//.substring(0,120);
        //             }
        //         }
        //     }
        // }else{
        ...
        //         if(window.innerWidth > 767){
        //             desctext = desctext.trim()//.substring(0,100);
        //         }else{
        //             desctext = desctext.trim()//.substring(0,120);
        //         }
        //     }
...
INC.methods.updateProductBlock = function (productBlock, findObj, blockType, bundleProductListCheck) {
    ...
    //         }
    //     }else{
    //         if(productObj.shortDescription.length > 130) {
    //             desctext = productObj.shortDescription.substring(0,120);
    //         }
    //     }
    // }else{
    //     if(desctext.length > 130) {
...
INC.methods.addProductToCart = function (findObj, qty, pageType, productBlock,add_btn_click,add_prod_im,btn_addtocart) {
    ...
    if (window.location.host == "m.feelunique.com" || window.location.hostname == "m.feelunique.com" || window.location.host == "mstage.staging.feelunique.com"){
        if(productObj.ProductType == "configurable"){
            if(productObj['id'].split('-')[1] != undefined){
                var url1 = addProductURL +"?" + "p="+productObj['id'].split('-')[1]+"&quantity="+qty+"&ajax=y"+"&e=1"+"&csrfToken="+csrf+"&s="+productObj['id'].split('-')[1]+"&pwa=1"
            }else{
    ...
    if(productObj.bundleId.toString().indexOf('1234500679') >= 0){
        ...
        Indicative.buildEvent('ProductAddToCart', {Date: date_current.split(' ')[0].toString(),ProductId:productObj.bundledProductId.toString(),BundleID: "",PrimaryProduct: productObj.mainId.toString(), SecondaryProduct:productObj.id.split('-')[1], Category:categoryId.toString(),Brand:'feelunique',NumberofBundles:'',BundlesShown:'No',ExperimentGroup:'',VisitorID:INC.config.ivid.toString(),Device:userDetails_[0].navigatoredevice.toString(),Referrer:document.referrer.toString(),Domain:'https://www.feelunique.com/',ReferrerProtocol:document.referrer.split('://')[0].toString(),PageType:'Product Details Page',PageID:pageType.toString(),OS:userDetails_[0].osname.toString(),OSVersion:userDetails_[0].osversion.toString(),BrowserName:userDetails_[0].browsernname.toString(),BrowserVersion:'',NavigatorUserAgent:userDetails_[0].navigatoruserAgent.toString(),NavigatorAppVersion:userDetails_[0].navigatorappVersion.toString(),NavigatorPlatform:userDetails_[0].navigatorplatform.toString(),NavigatorVendor :userDetails_[0].navigatorvendor.toString()},callbackFn);
        ...
        Indicative.buildEvent('ProductAddToCart', {Date: date_current.split(' ')[0].toString(),ProductId:productObj.bundledProductId.toString(),BundleID: eventDataObj["bundle_data"]["id"].toString(),PrimaryProduct: productObj.bundledProductId.toString(), SecondaryProduct:productObj.id.split('-')[1], Category:categoryId.toString(),Brand:'feelunique',NumberofBundles:'',BundlesShown:'No',ExperimentGroup:'',VisitorID:INC.config.ivid.toString(),Device:userDetails_[0].navigatoredevice.toString(),Referrer:document.referrer.toString(),Domain:'https://www.feelunique.com/',ReferrerProtocol:document.referrer.split('://')[0].toString(),PageType:'Product Details Page',PageID:pageType.toString(),OS:userDetails_[0].osname.toString(),OSVersion:userDetails_[0].osversion.toString(),BrowserName:userDetails_[0].browsernname.toString(),BrowserVersion:'',NavigatorUserAgent:userDetails_[0].navigatoruserAgent.toString(),NavigatorAppVersion:userDetails_[0].navigatorappVersion.toString(),NavigatorPlatform:userDetails_[0].navigatorplatform.toString(),NavigatorVendor :userDetails_[0].navigatorvendor.toString()},callbackFn);
...
INC.methods.addBundleToCart = function (btn_cart) {
    ...
    Object.keys(dataStore.bundleCartProducts).forEach(function (bundleCartProduct) {
        ...
        Indicative.buildEvent('IncBundleAddToCart', {Date: date_current.split(' ')[0].toString(),ProductId:INC.config.Product_id.toString(),BundleID: eventDataObj["bundle_data"]["id"].toString(),PrimaryProduct: productObj.bundledProductId.toString(), SecondaryProduct:productObj.id.split('-')[1], Category:categoryId.toString(),Brand:'feelunique',NumberofBundles:'',BundlesShown:'No',ExperimentGroup:'',VisitorID:INC.config.ivid.toString(),Device:userDetails_[0].navigatoredevice.toString(),Referrer:document.referrer.toString(),Domain:'https://www.feelunique.com/',ReferrerProtocol:document.referrer.split('://')[0].toString(),PageType:'Product Details Page',PageID:'100',OS:userDetails_[0].osname.toString(),OSVersion:userDetails_[0].osversion.toString(),BrowserName:userDetails_[0].browsernname.toString(),BrowserVersion:'',NavigatorUserAgent:userDetails_[0].navigatoruserAgent.toString(),NavigatorAppVersion:userDetails_[0].navigatorappVersion.toString(),NavigatorPlatform:userDetails_[0].navigatorplatform.toString(),NavigatorVendor :userDetails_[0].navigatorvendor.toString()},callbackFn);

        //Date: date_current.split(' ')[0]
        // Indicative.buildEvent('BundleAddToCart', {ProductId:INC.config.Product_id.toString(),Category:categoryId.toString(),Brand:'feelunique',NumberofBundles:INC.config.bundleCount.toString(),BundlesShown:'Yes',ExperimentGroup:'',VisitorID:INC.config.ivid,Device:userDetails_[0].navigatoredevice,Referrer:document.referrer,Domain:'https://www.feelunique.com/',ReferrerProtocol:document.referrer.split('://')[0],City:'',Country:'',State:'',Language:'EN',DeviceType:userDetails_[0].navigatoredevice,Browser:userDetails_[0].browsernname,PageType:'Product Details Page',PageID:'101',OS:userDetails_[0].osname.toString(),OSVersion:userDetails_[0].osversion.toString(),BrowserName:userDetails_[0].browsernname.toString(),BrowserVersion:'',NavigatorUserAgent:userDetails_[0].navigatoruserAgent.toString(),NavigatorAppVersion:userDetails_[0].navigatorappVersion.toString(),NavigatorPlatform:userDetails_[0].navigatorplatform.toString(),NavigatorVendor :userDetails_[0].navigatorvendor.toString(),BundleID:productObj.bundleId.toString(),ProductName:productObj.name.toString(),ProductID1:productObj.bundledProductId.toString(),ProductID2:productObj.id.toString()},callbackFn);
            ...
            success: function(data) {
                ...
                if(url2 != ""){
                    if( window.location.host == "www.feelunique.com" || window.location.host == "staging.feelunique.com"){
                        ...
                        if(document.querySelectorAll('button[aria-label="Cart"] span div')[2] != undefined){
                            var old_qty = document.querySelectorAll('button[aria-label="Cart"] span div')[2].innerText
                            document.querySelectorAll('button[aria-label="Cart"] span div')[2].innerHTML = +parseInt(old_qty) +  +parseInt(data.analytics.qty)
                        }
                    }
                    callprodB()
                }
...
function add_to_cart_tracking_multiple(mainProductId) {
    ...
    for (var k = 0; k < INC.config.bundle_tracking.length; k++) {
        if (INC.config.bundle_tracking.length == 1) {
            ...
            // Indicative.buildEvent('BundleAddToCart', {Date: date_current.split(' ')[0],BundleID1:INC.config.bundle_tracking[k].bid.toString(),ProductName:INC.config.bundle_tracking[k].pname.toString(),ProductID1:core_prod_id.toString(),ProductID2:INC.config.bundle_tracking[k].id.toString(),ProductId:INC.config.Product_id.toString(),Category:categoryId.toString(),Brand:'feelunique',NumberofBundles:INC.config.bundleCount.toString(),BundlesShown:'Yes',ExperimentGroup:'',VisitorID:INC.config.ivid,Device:userDetails_[0].navigatoredevice,Referrer:document.referrer,Domain:'https://www.feelunique.com/',ReferrerProtocol:document.referrer.split('://')[0],City:'',Country:'',State:'',Language:'EN',DeviceType:userDetails_[0].navigatoredevice,Browser:userDetails_[0].browsernname,PageType:'Product Details Page',PageID:'100',OS:userDetails_[0].osname.toString(),OSVersion:userDetails_[0].osversion.toString(),BrowserName:userDetails_[0].browsernname.toString(),BrowserVersion:'',NavigatorUserAgent:userDetails_[0].navigatoruserAgent.toString(),NavigatorAppVersion:userDetails_[0].navigatorappVersion.toString(),NavigatorPlatform:userDetails_[0].navigatorplatform.toString(),NavigatorVendor :userDetails_[0].navigatorvendor.toString()},callbackFn);
        } else {
            if (mainProductId != INC.config.bundle_tracking[k].id) {
                ...
                // Indicative.buildEvent('BundleAddToCart', {Date: date_current.split(' ')[0],BundleID:INC.config.bundle_tracking[k].bid.toString(),ProductName:INC.config.bundle_tracking[k].pname.toString(),ProductID1:core_prod_id.toString(),ProductID2:INC.config.bundle_tracking[k].id.toString(),ProductId:INC.config.Product_id.toString(),Category:categoryId.toString(),Brand:'feelunique',NumberofBundles:INC.config.bundleCount.toString(),BundlesShown:'Yes',ExperimentGroup:'',VisitorID:INC.config.ivid,Device:userDetails_[0].navigatoredevice,Referrer:document.referrer,Domain:'https://www.feelunique.com/',ReferrerProtocol:document.referrer.split('://')[0],City:'',Country:'',State:'',Language:'EN',DeviceType:userDetails_[0].navigatoredevice,Browser:userDetails_[0].browsernname,PageType:'Product Details Page',PageID:'100',OS:userDetails_[0].osname.toString(),OSVersion:userDetails_[0].osversion.toString(),BrowserName:userDetails_[0].browsernname.toString(),BrowserVersion:'',NavigatorUserAgent:userDetails_[0].navigatoruserAgent.toString(),NavigatorAppVersion:userDetails_[0].navigatorappVersion.toString(),NavigatorPlatform:userDetails_[0].navigatorplatform.toString(),NavigatorVendor :userDetails_[0].navigatorvendor.toString()},callbackFn);
            }
            // Indicative.buildEvent('BundleAddToCart', {Date: date_current.split(' ')[0],ProductId:INC.config.Product_id.toString(),Category:categoryId.toString(),Brand:'feelunique',NumberofBundles:INC.config.bundleCount.toString(),BundlesShown:'Yes',ExperimentGroup:'',VisitorID:INC.config.ivid,Device:userDetails_[0].navigatoredevice,Referrer:document.referrer,Domain:'https://www.feelunique.com/',ReferrerProtocol:document.referrer.split('://')[0],City:'',Country:'',State:'',Language:'EN',DeviceType:userDetails_[0].navigatoredevice,Browser:userDetails_[0].browsernname,PageType:'Product Details Page',PageID:'100',OS:userDetails_[0].osname.toString(),OSVersion:userDetails_[0].osversion.toString(),BrowserName:userDetails_[0].browsernname.toString(),BrowserVersion:'',NavigatorUserAgent:userDetails_[0].navigatoruserAgent.toString(),NavigatorAppVersion:userDetails_[0].navigatorappVersion.toString(),NavigatorPlatform:userDetails_[0].navigatorplatform.toString(),NavigatorVendor :userDetails_[0].navigatorvendor.toString(),BundleID:INC.config.bundle_tracking[k].bid.toString(),ProductName:INC.config.bundle_tracking[k].pname.toString(),ProductID1:core_prod_id.toString(),ProductID2:INC.config.bundle_tracking[k].id.toString()},callbackFn);
        }
...
INC.methods.buildCrawlDataObj = function buildCrawlDataObj() {
    function buildCrawlDataObj() {
        ...
        if(document.querySelector('.swatches.color li.selected input') != null){
            ...
            var quantity = (elQuantity != null) ? ((elQuantity.innerText == "ADD TO BAG") ? 100 : 0) : 0;
...
INC.methods.autoSelectMainProductSizeVarient = function(){
    var productObj = INC.methods.buildCrawlDataObj();
    var mainId = decodeURIComponent(productObj.productName);
    var sizeText = productObj.size;

    findObj = new INC.classes.FindObj({ mainId: mainId, sizeText: sizeText });
    
    var productBlock = document.querySelector('.inc_product_block');
    
    if(document.querySelector('.inc_pdp_product-main_block .inc_product_modal_block .inc_product_desc_att_size_list_item_img_block[data-size="' + sizeText + '"]') != null){
        document.querySelector('.inc_pdp_product-main_block .inc_product_modal_block .inc_product_desc_att_size_list_item_img_block[data-size="' + sizeText + '"]').click();
    }    
}
...
INC.methods.autoSelectMainProductColorVarient = function(){
    if(document.querySelector('.swatches.color li.selected input') != null){
        ...
        if(document.querySelector('.inc_pdp_product-main_block .inc_product_modal_block .inc_product_desc_att_color_list_item_img_block[data-color="' + colorText + '"]') != null){
            if(document.querySelector('.inc_pdp_product-main_block .inc_product_modal_block .inc_product_desc_att_color_list_item_img_block[data-color="' + colorText + '"]').parentNode.classList.contains('active') == false){
...
function update_plp_sidebar(prod_wrapper,errhtml){
    ...
    setTimeout(function() {
        if(prod_wrapper.querySelector('a') != null){
            ...
            if (product_wrap.querySelector('.strong.font-color-red') != null) { 
                var s_prc = product_wrap.querySelector('.price-container span').innerText.replace(/[^\d\.\,\s]+/g, '');
                var prc = product_wrap.querySelector('.price-container span.orig-price').innerText.replace(/[^\d\.\,\s]+/g, '');
            }
...
function get_banners_for_empty_sidebar(){
    // if(window.location.host == "staging2-web.partycity.com"){
    //     var url="https://staging2-web.partycity.com/"
    // }else{
    //     var url= "https://www.partycity.com"
    // }
    // $.ajax({
    //     type: "GET",
    //     url: url,
    //     contentType: "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9",
    //     error: function(jqXHR, textStatus, errorMessage) {
            
    //     },
    //     success: function(data) {
    //         var banner_elm = jQuery(data).find('#main');
    //         var category_deals=banner_elm[0].querySelector('.o_category-list-block').parentNode
    //         var inc_banner  = banner_elm[0].querySelector('.o_carousel-block.carousel-secondary.o_video-block').parentNode
    //         document.querySelector('.inc_recommended_products_block').innerHTML=""
    //         document.querySelector('.inc_recommended_products_block').appendChild(category_deals)
    //         if(window.innerWidth > 768){
    //             document.querySelector('.inc_recommended_products_block').setAttribute('style','display:block;padding:40px 0px;')
    //         }else {
    //             document.querySelector('.inc_recommended_products_block').setAttribute('style','display:block;padding:10px 0px;')
    //         }
    //         document.querySelector('.inc_recommended_products_block').classList.add('inc_banner')
    //         var cat_list=document.querySelectorAll('.o_category-list-block li')
    //         for(c=0;c<cat_list.length;c++){
    //             if(cat_list[c].innerText == "Today's Deals" || cat_list[c].innerText == "Clearance" || cat_list[c].innerText == "Bulk Buys"){
    //                 var img_src = cat_list[c].querySelector('img').getAttribute('data-src')
    //                 cat_list[c].querySelector('img').src=img_src
    //                 cat_list[c].style.display="block"
    //                 //
    //             }else{
    //                 cat_list[c].style.display="none"
    //             }
    //         }
    //         var img = document.querySelectorAll('.inc_recommended_products_block img[data-src], source[data-srcset]');
            
    //         //data-src
    //         // var data_a=document.querySelectorAll('.inc_recommended_products_block .o_carousel-block a')
    //         // var dotswraper=document.querySelector('.inc_recommended_products_block .m_carousel-nav');
    //         // var dot_wrapper=document.createElement('ul');
    //         // dot_wrapper.classList.add('inc_dots')
    //         // dotswraper.appendChild(dot_wrapper)
    //         // for(var t = 0; t< data_a.length; t++) {
    //         //     if(data_a[t] != undefined){
    //         //         data_a[t].style.display="block"
    //         //     }
    //         //     var dot_li = document.createElement('li');
    //         //     if(t == 0){
    //         //         dot_li.classList.add('active');
    //         //     }
    //         //     dot_wrapper.appendChild(dot_li)
...
function execute_import_tracking() {
    ...
    if (a == true && is_visible_elem_counter < 1) {
        if(INC.config.pageType == "pdp"){
            ...
            Indicative.buildEvent('BundleViews', {Date: date_current.split(' ')[0],ProductId:INC.config.Product_id.toString(),Category:categoryId.toString(),Brand:'feelunique',NumberofBundles:INC.config.bundleCount.toString(),BundlesShown:'Yes',ExperimentGroup:'',VisitorID:INC.config.ivid,Device:userDetails_[0].navigatoredevice,Referrer:document.referrer,Domain:'https://www.feelunique.com/',ReferrerProtocol:document.referrer.split('://')[0],City:'',Country:'',State:'',Language:'EN',DeviceType:userDetails_[0].navigatoredevice,Browser:userDetails_[0].browsernname,PageType:'Product Details Page',PageID:'100',OS:userDetails_[0].osname.toString(),OSVersion:userDetails_[0].osversion.toString(),BrowserName:userDetails_[0].browsernname.toString(),BrowserVersion:'',NavigatorUserAgent:userDetails_[0].navigatoruserAgent.toString(),NavigatorAppVersion:userDetails_[0].navigatorappVersion.toString(),NavigatorPlatform:userDetails_[0].navigatorplatform.toString(),NavigatorVendor :userDetails_[0].navigatorvendor.toString()},callbackFn);
